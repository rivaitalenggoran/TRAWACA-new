...
$query = "SELECT id_header FROM publikasi_peneliti_header";
    ...
    <div class="admin-content" id="content">
        <div class="container mt-4">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php foreach ($HeaderPublikasi as $rowHeader) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="CRU/header_publikasi_edit.php?edit=<?= $rowHeader['id_bahasa']; ?>" class="btn btn-warning btn-sm">Edit</a>

                                <!-- Hapus, pastikan link mengarah ke hapus berdasarkan id_bahasa -->
                                <a href="?deleteheaderpublikasi=<?= $rowHeader['id_bahasa']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
