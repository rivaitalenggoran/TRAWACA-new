...
$query = "SELECT nama_header FROM beranda_header WHERE id_header = ?";
...
<div class="container mt-5">
    <h2 class="text-center mb-4">Tambah Header Beranda Bahasa</h2>
    ...
    <form method="POST" class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea name="sub_header" class="form-control" placeholder="Isi Sub Header (opsional)" rows="3"></textarea>
        </div>
