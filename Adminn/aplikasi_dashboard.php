                ...
                <tbody>
                    <?php foreach ($Aplikasi as $row) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="CRU/aplikasi.php?edit=<?= $row['id_aplikasi']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                <a href="?deleteaplikasi=<?= $row['id_aplikasi']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
