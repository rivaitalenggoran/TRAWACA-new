...
<head>
    ...
    <title>TRAWACA Bahasa - Dashboard</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <a href="bahasa_dashboard.php" class="active"><i class="fa fa-calendar"></i> <span class="menu-text">Bahasa</span></a>
...
<!----------------------- Bahasa Content --------------------------------------------------------------------->     
            <h3 class="mb-1">Tabel Bahasa</h3>        

            <a href="CRU/bahasa.php" class="btn btn-primary mb-3">Tambah Bahasa</a>
                ...
                <tbody>
                    <?php foreach ($Bahasa as $row) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="CRU/bahasa.php?edit=<?= $row['id_bahasa']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                <a href="?deletebahasa=<?= $row['id_bahasa']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
