    ...
    <form method="POST" class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="kode_bahasa" class="form-control" id="kode_bahasa"
                value="<?php echo isset($row['kode_bahasa']) ? $row['kode_bahasa'] : ''; ?>" disabled>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="tahun_pengerjaan_karya" class="form-control" id="tahun_pengerjaan_karya"
                value="<?php echo isset($row['tahun_pengerjaan_karya']) ? $row['tahun_pengerjaan_karya'] : ''; ?>" disabled>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="tautan_karya" class="form-control" id="tautan_karya"
                value="<?php echo isset($row['tautan_karya']) ? $row['tautan_karya'] : ''; ?>" disabled>
        </div>
