<?php
include '../../backend/peneliti_publikasi_backend.php';  // Pastikan file backend sudah sesuai dengan nama dan path yang benar
?>
...
<div class="container mt-5">
    ...
    <form method="POST" class="mb-3">
        <input type="hidden" name="id_publikasi" id="id_publikasi" value="<?php echo isset($row['id_publikasi']) ? $row['id_publikasi'] : ''; ?>">
