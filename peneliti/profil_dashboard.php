...
$stmt->execute();
$ID_profil = $stmt->fetchAll(PDO::FETCH_ASSOC);
// UNTUK DATA MULTILINGUAL --------------------------
?>
...
<body>
    ...
    <a href="profil_dashboard.php?id_peneliti=<?= $id_peneliti; ?>" class="active">
    ...
    <div class="peneliti-content" id="content">
        <div class="container mt-4">
            ...
            <h4 class="mb-1">NOTES : DATA DI TABEL PROFIL JANGAN DIHAPUS SEMUA</h4>
            <a href="CRU/peneliti_tambah_bahasa.php?id_peneliti=<?= $id_peneliti; ?>" class="btn btn-primary mb-3">Tambah Bahasa Peneliti</a>
            ...
            <?php if ($selected_profil): ?>
                <tbody>
                    <?php foreach ($selected_profil as $rowPeneliti) : ?>             
                        <tr>
                            ...
                            <td>
                                <a href="CRU/peneliti_edit.php?edit=<?= $rowPeneliti['id_bahasa']; ?>" class="btn btn-warning btn-sm">Edit</a>
